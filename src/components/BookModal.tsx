...
export default function BookModal() {
  ...
  }, [selectedBookIndex, selectedSeriesId, closeBook, goToNextBook, goToPrevBook]);
      ...
      >
        ...
        >
          ...
          <div className="px-5 sm:px-10 py-5 border-t border-white/5">
            <h3
              className="text-base sm:text-lg font-bold text-white mb-3 flex items-center gap-2"
            >
              <BookOpen
